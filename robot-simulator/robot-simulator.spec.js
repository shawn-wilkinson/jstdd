...
describe('Robot', function() {
  ...
  it('backwards when facing north', function() {
    robot.at(0,0);
    robot.orient('north');
    robot.backwards();
    expect(robot.coordinates).toEqual([0,-1]);
  ...
  it('instructions for backwards', function() {
    expect(robot.instructions('B')).toEqual(['backwards']);
  });
